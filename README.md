...
- 💾 **Settings persist** across restarts (favorite languages, active language, hotkey, smart mode, vocabulary, model, insertion mode, replacements) in `~/.config/just-voice-type/config.json`.
